...
def show_popup_window():
    st.write("This is an open source trivia game focused on helping memorize key historical events. Simply, choose challenges if you wish to and select a category to start. Good luck! ")
