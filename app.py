...
TRIVIA_CATEGORIES = {
    "Mao's China and Japan": {
        ...
        "When did the Three and Five anti campaings happen?": "1951.1952",
...
def show_popup_window():
    st.write(
        "This is an open source trivia game to help memorize key historical events. "
        "Pick your challenges, choose a category, and go. Good luck!"
    )
